...
import { Key, ShieldCheck, Smartphone, Users } from "lucide-react";

// Dynamically import Three.js lock canvas with SSR disabled to prevent server-side errors
const LockCanvas = dynamic(() => import("./LockCanvas"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full min-h-[380px] md:min-h-[440px] bg-slate-950 rounded-[2.5rem] border border-slate-800 flex items-center justify-center relative overflow-hidden">
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="font-mono text-xs text-gray-500 uppercase tracking-widest">Initializing 3D Lock...</span>
      </div>
    </div>
  ),
});
...
export default function LockHero({ title, description, longDescription, bgImage }: LockHeroProps) {
  const lockFeatures = [
    {
      icon: ShieldCheck,
      title: "Keyless Protection",
      description: "Secure biometric and numeric panel overrides.",
      color: "text-[#f2392c]",
      bgColor: "bg-[#f2392c]/10"
    },
    {
      icon: Smartphone,
      title: "Remote App Controls",
      description: "Manage entry codes and logs on your mobile app.",
      color: "text-[#ff7e15]",
      bgColor: "bg-[#ff7e15]/10"
    },
    {
      icon: Key,
      title: "RFID card & Passcodes",
      description: "Generate temporary codes for visitors.",
      color: "text-[#8a3ffc]",
    ...
    },
    {
      ...
      description: "Assign individual access logs for family & staff.",
    ...
    <section className="relative pt-32 pb-20 md:py-36 overflow-hidden bg-slate-900 text-white min-h-[90vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-4">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-800/80 border border-slate-700/80 text-xs font-semibold tracking-wider text-[#ff7e15] uppercase shadow-sm">
                ...
                Advanced Home Automation Access
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <a 
                href="https://wa.me/917994357565?text=Hello!%20I'm%20interested%20in%20your%20Smart%20Lock%20installation%20services."
                target="_blank"
          ...
          {/* Right Column: Three.js Interactive Lock View */}
