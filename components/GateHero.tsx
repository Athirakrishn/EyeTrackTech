...
import { ShieldAlert, Compass, Cpu, Smartphone } from "lucide-react";

// Dynamically import Three.js gate canvas with SSR disabled to prevent server-side errors
const GateCanvas = dynamic(() => import("./GateCanvas"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full min-h-[380px] md:min-h-[440px] bg-slate-950 rounded-[2.5rem] border border-slate-800 flex items-center justify-center relative overflow-hidden">
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="font-mono text-xs text-gray-500 uppercase tracking-widest">Initializing 3D Gate...</span>
      </div>
    </div>
  ),
});
...
export default function GateHero({ title, description, longDescription, bgImage }: GateHeroProps) {
  const gateFeatures = [
    {
      icon: Cpu,
      title: "Heavy-Duty Motors",
      description: "Dual actuator arms for silent and reliable swing gate operations.",
      color: "text-[#ff7e15]",
      bgColor: "bg-[#ff7e15]/10"
    },
    {
      icon: Smartphone,
      title: "App & Keychain Controls",
      description: "Trigger entry access points directly from your mobile app.",
      color: "text-[#8a3ffc]",
    ...
    },
    {
      ...
      description: "Infrared safety loop sensors to prevent accidental closures.",
      color: "text-[#f2392c]",
    ...
    },
    {
      ...
      description: "Centralize your automated doors, lighting, and gate logs.",
    ...
    <section className="relative pt-32 pb-20 md:py-36 overflow-hidden bg-slate-900 text-white min-h-[90vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-4">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-800/80 border border-slate-700/80 text-xs font-semibold tracking-wider text-[#ff7e15] uppercase shadow-sm">
                <span className="w-2 h-2 rounded-full bg-[#ff7e15] animate-pulse" />
                Automatic Gate Openers & Hubs
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <a 
                href="https://wa.me/917994357565?text=Hello!%20I'm%20interested%20in%20your%20Gate%20Automation%20services."
                target="_blank"
          ...
          {/* Right Column: Three.js Interactive Gate View */}
          <div className="lg:col-span-6 relative w-full flex justify-center items-center">
            {/* Background glowing aura decoration */}
            <div className="absolute -inset-4 bg-gradient-to-tr from-[#ff7e15]/20 to-[#8a3ffc]/20 rounded-[3.5rem] blur-2xl pointer-events-none opacity-50" />
